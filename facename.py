...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        # Classifica o rosto com a sua rede neural e armazena o nome na variável 'name'
        name = classify_face(frame[y:y+h, x:x+w])
        
        # Desenha o nome na imagem
        cv2.putText(frame, name, (x, y-10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)

    # Mostra o quadro atual com os rostos detectados e os nomes
